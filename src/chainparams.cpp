...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (1, uint256("0x000006d630d51183cd2d79342c64c0624d1e6edc0c1def51262c2faab6ea1f42"))
    (45, uint256("0x0000005a887dd9295ade4553b967e2827c6fe121e3194c5fec9b185e1f3f7e33"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1538644732, // * UNIX timestamp of last checkpoint block
    46,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 1188;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Mfit starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Mfit: 1 day
        nTargetSpacing = 1 * 60;  // Mfit: 1 minute
        nLastPOWBlock = 715;
        nMaturity = 75;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1538042109;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 349082;
		
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000006828e7c1abf187480c58b76e8c321f34fa205ee588f40738272fbf777a"));
        assert(genesis.hashMerkleRoot == uint256("0x6e7d125c34de4900eebd6e50addb772ed22fb8191a778f8dca479e52db7a0447"));

        vSeeds.push_back(CDNSSeedData("104.248.159.84", "104.248.159.84"));
        vSeeds.push_back(CDNSSeedData("104.248.116.47", "104.248.116.47"));
        vSeeds.push_back(CDNSSeedData("142.93.32.240", "142.93.32.240"));
		vSeeds.push_back(CDNSSeedData("178.128.226.95", "178.128.226.95"));
		vSeeds.push_back(CDNSSeedData("142.93.162.83", "142.93.162.83"));
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet mfit addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet mfit script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet mfit BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mfit BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet mfit BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Mfit: 1 day
        nTargetSpacing = 1 * 60;        // Mfit: 1 minutes
