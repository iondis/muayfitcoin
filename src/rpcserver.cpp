...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mfit features */
        {"mfit", "masternode", &masternode, true, true, false},
        {"mfit", "listmasternodes", &listmasternodes, true, true, false},
        {"mfit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mfit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mfit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mfit", "masternodedebug", &masternodedebug, true, true, false},
        {"mfit", "startmasternode", &startmasternode, true, true, false},
        {"mfit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mfit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mfit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mfit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mfit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mfit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mfit", "mnbudget", &mnbudget, true, true, false},
        {"mfit", "preparebudget", &preparebudget, true, true, false},
        {"mfit", "submitbudget", &submitbudget, true, true, false},
        {"mfit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mfit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mfit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mfit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mfit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mfit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mfit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mfit", "checkbudgets", &checkbudgets, true, true, false},
        {"mfit", "mnsync", &mnsync, true, true, false},
        {"mfit", "spork", &spork, true, true, false},
        {"mfit", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mfit", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mfitd, or the -server option to mfit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mfit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1189/\n";
}
