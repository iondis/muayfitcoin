...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("MUAYFIT Core");
    QString versionText = QString(tr("Version v1.0.0.0-MainNet")).arg(QString::fromStdString(FormatFullVersion()));
	...
	QString copyrightTextMfit = QChar(0xA9) + QString(tr(" 2018 The Muayfit Core developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextMfit);
