...
This mechanism has been integrated into Bitcore-Node-Mfit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Mfit-Project/insight-api-mfit#web-socket-api](https://github.com/Mfit-Project/insight-api-mfit#web-socket-api) 
* API: [https://github.com/Mfit-Project/insight-api-mfit#swifttx-transactions](https://github.com/Mfit-Project/insight-api-mfit#swifttx-transactions) 
...
By default, the Mfit Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mfit Core daemon:
