                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Muayfit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mfit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mfit: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Muayfit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Muayfit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mfit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mfit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mfit addresses"));
    ...
    openAction->setStatusTip(tr("Open a Mfit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Muayfit Core help message to get a list with possible Mfit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Muayfit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mfit network", "", count));
}
...
{
    QString strTitle = tr("Muayfit Core"); // default title
