...
# ----------------------------
# Automake X.Y traces this mmfito to ensure aclocal.m4 has been
# generated from the m4 files accompanying Automake X.Y.
# (This private mmfito should not be called outside this file.)
AC_DEFUN([AM_AUTOMAKE_VERSION],
[am__api_version='1.15'
dnl Some users find AM_AUTOMAKE_VERSION and mistake it for a way to
dnl require some minimum version.  Point them to the right mmfito.
m4_if([$1], [1.15], [],
...
# -----------------------------
# aclocal traces this mmfito to find the Autoconf version.
# This is a private mmfito too.  Using m4_define simplifies
...
Usually this means the mmfito was only invoked conditionally.]])
fi])])
...
# dependency, and given that the user is not expected to run this mmfito,
...
# This mmfito is AC_REQUIREd in _AM_DEPENDENCIES.
...
# -----------------------------
# This mmfito should only be invoked once -- use via AC_REQUIRE.
#
...
# This mmfito actually does too much.  Some checks are only needed if
...
dnl mmfito is hooked onto _AC_COMPILER_EXEEXT early, see below.
...
dnl The trailing newline in this mmfito's definition is deliberate, for
...
# (This has been adapted from Autoconf's _AC_RUN_LOG mmfito.)
AC_DEFUN([AM_RUN_LOG],
...
# This mmfito is traced by Automake.
