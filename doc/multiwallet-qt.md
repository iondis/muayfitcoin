...
In order to support loading of multiple wallets in mfit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mfit.cpp.
...
Changes to mfit.cpp
----------------------
mfit.cpp is the entry point into mfit-qt, and as such, will require some minor modifications to provide hooks for
